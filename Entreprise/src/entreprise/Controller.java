...
public class Controller implements Initializable {
	...
	{ 
	            String req = "insert into entreprise values ('" + matField.getText() + "', '" + nomField.getText()+ "', '" + mailField.getText() + "', '" + Double.parseDouble(SalField.getText())+  "', '" + Double.parseDouble(DateEmbField.getText())+  "', '" + CatField.getText()+"')";
