...
public class Controller implements Initializable {
	...
	{ 
	            String req = "insert into entreprise values ('" + matField.getText() + "', '" + nomField.getText()+ "', '" + mailField.getText() + "', '" + Double.parseDouble(DateEmbField.getText())+  "', '" + Double.parseDouble(SalField.getText())+  "', '" + CatField.getText()+"')";
...
{ 
	...
	{ 
	 ...
	 table.getItems().addAll(salData.getImportList());
	...
	{ 
	 table.getItems().addAll(salData.getExportList());
	...
	try {
	 ...
	 for(Salarie sl: salData.getImportList()) {
	   try {
